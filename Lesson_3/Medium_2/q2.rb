def fun_with_ids
  ...
  # id's should be same as beginning before method call
...
def an_illustrative_method(a_outer, b_outer, c_outer, d_outer, a_outer_id, b_outer_id, c_outer_id, d_outer_id)
  # should be the same inside the method and outside the method
  ...
  # ID's should stay te same inside method
