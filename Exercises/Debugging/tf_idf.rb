...
# expected outputs:
# puts tfidf("cat", document1, documents) # ~ 1.2  --- 0
# puts tfidf("cat", document2, documents) # ~ 1.6   --- 0
# puts tfidf("cat", document3, documents) # 0

puts tfidf("quantum", document1, documents) # ~ 5.5  --- 5.493061443340549
...
# puts tfidf("mastery", document3, documents) # ~ 3.3  --- 3.295836866004329

# puts tfidf("some", document1, documents) # 0
# puts tfidf("some", document2, documents) # ~ 0.4 --- 0
# puts tfidf("some", document3, documents) # ~ 0.4 --- 0